...
namespace prioritized_acc_inverse_kinematics_solver_sample{
  ...
  class sample9_collision_moveItem : public choreonoid_viewer::ViewerBaseItem {
  public:
    static void initializeClass(cnoid::ExtensionManager* ext){ ext->itemManager().registerClass<sample9_collision_moveItem>("sample9_collision_moveItem"); }
  protected:
    virtual void main() override{ sample9_collision_move(); return; }
  };
  typedef cnoid::ref_ptr<sample9_collision_moveItem> sample9_collision_moveItemPtr;

  void sample10_angular();
  class sample10_angularItem : public choreonoid_viewer::ViewerBaseItem {
  public:
    static void initializeClass(cnoid::ExtensionManager* ext){ ext->itemManager().registerClass<sample10_angularItem>("sample10_angularItem"); }
  protected:
    virtual void main() override{ sample10_angular(); return; }
  };
  ...
  class sample13_wrench_ikItem : public choreonoid_viewer::ViewerBaseItem {
  public:
    static void initializeClass(cnoid::ExtensionManager* ext){ ext->itemManager().registerClass<sample13_wrench_ikItem>("sample13_wrench_ikItem"); }
  protected:
    virtual void main() override{ sample13_wrench_ik(); return; }
  };
  typedef cnoid::ref_ptr<sample13_wrench_ikItem> sample13_wrench_ikItemPtr;

  void sample14_wrench_move();
  class sample14_wrench_moveItem : public choreonoid_viewer::ViewerBaseItem {
  public:
    static void initializeClass(cnoid::ExtensionManager* ext){ ext->itemManager().registerClass<sample14_wrench_moveItem>("sample14_wrench_moveItem"); }
  protected:
    virtual void main() override{ sample14_wrench_move(); return; }
  };
